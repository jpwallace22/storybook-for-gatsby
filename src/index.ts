 ...
 */
export const config = (entries: string[] = [], _options: AddonOptions): string[] => {
  return [...entries, require.resolve('./preview.js')];
};
 ...
 */
export const webpackFinal = (config: any, _options: AddonOptions): WebpackConfiguration => {
  ...
  // see @https://stackoverflow.com/a/73724183
  config.plugins.push(new webpack.NormalModuleReplacementPlugin(/^@reach\/router/, '@gatsbyjs/reach-router'));
